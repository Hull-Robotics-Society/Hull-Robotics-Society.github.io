...
<div style="float: left; width: 125px; margin-right: 30px; margin-bottom: 10px;">
  <video controls style="width: 100%; height: auto;">
    <source src="/media/dalek/100-leaders/dalek-100-01.mp4" type="video/mp4">
...
<div style="display: flex; gap: 10px; flex-wrap: wrap; justify-content: center;">
  ...
  <img src="/images/dalek/100-leaders/dalek-100-11.jpg" alt="The Dalek ready to roll" style="width: 48%; max-width: 400px; height: auto;" />
</div>
...
<div style="float: right; width: 250px; margin-left: 15px; margin-bottom: 10px;">
  <video controls style="width: 100%; height: auto;">
    <source src="/media/dalek/100-leaders/dalek-100-04.mp4" type="video/mp4">
    Your browser does not support the video tag.
  </video>
</div>
...
<div style="text-align: center;">
  <video controls style="max-width: 640px; width: 100%;">
    <source src="/media/dalek/100-leaders/dalek-100-02.mp4" type="video/mp4">
  </video>
</div>
...
> Get in touch: [uniofhullroboticsociety@gmail.com](mailto:uniofhullroboticsociety@gmail.com)
...
<div style="display: flex; gap: 10px; flex-wrap: wrap; justify-content: center;">
  <img src="/images/dalek/100-leaders/dalek-100-08.jpg" alt="Our team who took part" style="width: 48%; max-width: 400px; height: auto;" />
  
  <video controls style="width: 48%; max-width: 400px; height: auto;">
    <source src="/media/dalek/100-leaders/dalek-100-03.mp4" type="video/mp4">
    Your browser does not support the video tag.
  </video>
</div>
...
*#MindControlledDalek #CommunityInnovation #EEGTech #EastRidingLeaders #STEMEngagement #NodeRED #BCI*
