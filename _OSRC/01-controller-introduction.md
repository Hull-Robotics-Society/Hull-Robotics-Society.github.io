...
1. **CAD Design & 3D Printing Process** – How we designed and manufactured the enclosure.
2. **Hardware Assembly** – Step-by-step guide to assembling the remote.
3. **Software Setup** – Installing and configuring ROS & ROS2 on the Raspberry Pi.
4. **Control & Customization** – Exploring how the remote communicates with robots and how users can extend its functionality.
